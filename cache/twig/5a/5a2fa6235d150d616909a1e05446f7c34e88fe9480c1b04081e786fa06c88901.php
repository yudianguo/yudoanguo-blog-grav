...
class __TwigTemplate_4d78f84113a61cba12e4f366793e39844c458b907087f9ad3d2de19cff65d81f extends Twig_Template
{
    ...
    {
        // line 1
        $context["feed_url"] = (((($this->getAttribute((isset($context["blog"]) ? $context["blog"] : null), "url", array()) == "/") || ($this->getAttribute((isset($context["blog"]) ? $context["blog"] : null), "url", array()) == (isset($context["base_url_relative"]) ? $context["base_url_relative"] : null)))) ? (((        // line 2
(isset($context["base_url_relative"]) ? $context["base_url_relative"] : null) . "/") . $this->getAttribute((isset($context["blog"]) ? $context["blog"] : null), "slug", array()))) : ($this->getAttribute(        // line 3
(isset($context["blog"]) ? $context["blog"] : null), "url", array())));
        // line 4
        $context["new_base_url"] = ((($this->getAttribute((isset($context["blog"]) ? $context["blog"] : null), "url", array()) == "/")) ? ("") : ($this->getAttribute(        // line 6
(isset($context["blog"]) ? $context["blog"] : null), "url", array())));
        // line 7
        echo "
";
...
";
  ...
  ";
        // line 18
        echo "  ";
        $context["content"] = $this->getAttribute($this->getAttribute((isset($context["pages"]) ? $context["pages"] : null), "find", array(0 => "/sidebar-markdown-widget"), "method"), "content", array());
        // line 19
        echo "  ";
  ...
  ";
            ...
            // line 22
            echo "    ";
            $context["content"] = $this->getAttribute($this->getAttribute((isset($context["pages"]) ? $context["pages"] : null), "find", array(0 => "/sidebar"), "method"), "content", array());
            // line 23
            echo "    ";
            if ((isset($context["content"]) ? $context["content"] : null)) {
                // line 24
...
";
    ...
    ";
            // line 44
            $this->loadTemplate("partials/taxonomylist.html.twig", "partials/sidebar.html.twig", 44)->display(array_merge($context, array("base_url" => (isset($context["new_base_url"]) ? $context["new_base_url"] : null), "taxonomy" => "tag")));
            // line 45
            echo "  </div>
";
        }
    ...
    ";
            // line 50
            $this->loadTemplate("partials/archives.html.twig", "partials/sidebar.html.twig", 50)->display(array_merge($context, array("base_url" => (isset($context["new_base_url"]) ? $context["new_base_url"] : null))));
            // line 51
            echo "  </div>
";
        }
