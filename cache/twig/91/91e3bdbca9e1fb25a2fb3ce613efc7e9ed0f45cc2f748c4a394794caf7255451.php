    ...
    public function block_contents($context, array $blocks = array())
    {
        ...
        if ($this->getAttribute(($context["field"] ?? null), "sublabel", array())) {
            ...
            echo "                <div class=\"form-sublabel\">
                    ";
            // line 39
            echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->markdownFunction($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter($this->getAttribute(($context["field"] ?? null), "sublabel", array())));
            echo "
                </div>
                ";
        }
...
{% endblock %}
", "forms/field.html.twig", "/var/www/yudoanguo-blog-grav/user/plugins/admin/themes/grav/templates/forms/field.html.twig");
    }
}
