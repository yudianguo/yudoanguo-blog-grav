            ...
            if (twig_test_iterable($context["item_value"])) {
                ...
                foreach ($context['_seq'] as $context["subkey"] => $context["suboption"]) {
                    ...
                    if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                        // line 35
                        echo "                                    ";
                        echo $this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter($context["suboption"]);
                    } else {
                ...
                echo "\">";
                if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) {
                    echo $this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter($context["item_value"]);
                } else {
...
{% endblock %}
", "forms/fields/select/select.html.twig", "/var/www/yudoanguo-blog-grav/user/plugins/form/templates/forms/fields/select/select.html.twig");
    }
}
